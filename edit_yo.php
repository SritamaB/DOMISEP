<?php
	...
	$queryUpdateValues= "UPDATE user SET FirstName = '$FirstName', LastName='$LastName', Password='$Password' WHERE Userid = '$userID'";
	...
	if ($FirstName==$firstNameUpdated and $LastName=$lastNameUpdated and $Password=$PasswordUpdated) {
		$match =;
		# code...
	}
?>
